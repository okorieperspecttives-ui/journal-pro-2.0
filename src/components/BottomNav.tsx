...
export default function BottomNav() {
  return (
    <nav className="fixed bottom-1 left-0 right-0 h-16 w-[95%] mx-auto bg-blue-600  rounded-full flex justify-around items-center md:hidden shadow-xs shadow-gray-500 safe-bottom z-50">
      {/* Dashboard */}
      <NavLink
        to="/dashboard"
        className={({ isActive }) =>
